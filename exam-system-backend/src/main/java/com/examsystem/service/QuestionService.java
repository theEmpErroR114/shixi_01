...
public interface QuestionService {
    ...
    PageResult<Question> listQuestions(Long teacherId, Long courseId, Integer questionType, Integer difficulty, String keyword, Integer page, Integer pageSize, List<Long> courseIds);
